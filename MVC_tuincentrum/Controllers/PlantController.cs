    ...
    public class PlantController : Controller
    {
        ...
        public ActionResult FotoUpload(int id)
        {
            if (Request.Files.Count > 0)
            {
                ...
                var absoluutPadNaarDir =
                    HttpContext.Server.MapPath("~/Images/Fotos");
                var absoluutPadNaarFoto =
                    Path.Combine(absoluutPadNaarDir, id + ".jpg");
        ...
        public ActionResult FindPlantenByKleur(string kleur)
        {
            List<Plant> PlantenLijst = new List<Plant>();
        ...
        public ActionResult FindplantByNaam(string naam)
        {
